                                            ...
                                            <div className={`glass-card p-4 md:p-8 space-y-8 group/item transition-all duration-300 shadow-xl shadow-black/5 ${isCompleted ? 'border-primary/80 bg-primary/5 opacity-100 ring-4 ring-primary/20' : 'border-border/50 hover:border-primary/50 opacity-80'}`}>
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full bg-transparent border-none text-2xl font-black placeholder:text-muted-foreground/30 focus:outline-none text-[#2F3D4A] p-0"
                                                    />
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-border/50">
                                                    <div className="space-y-4">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-slate-100 border-2 border-border focus:border-indigo-500 rounded-2xl px-6 py-4 text-sm font-bold outline-none transition-all shadow-inner text-[#2F3D4A]"
                                                        />
                                                    </div>
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-slate-100 border-2 border-border focus:border-pink-500 rounded-2xl px-6 py-4 text-sm font-bold outline-none transition-all shadow-inner text-[#2F3D4A]"
                                                        />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div key={idx} className={`glass-card p-6 space-y-5 transition-all duration-300 ${isCompleted ? 'border-primary/80 bg-primary/5 opacity-100 ring-4 ring-primary/20' : 'hover:border-primary/40 border-border/50 opacity-80'}`}>
                                            <div className="flex items-center justify-between border-b border-border/50 pb-3">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-[140px] text-right bg-transparent border-none text-sm font-bold placeholder:text-muted-foreground/50 focus:outline-none ${isCompleted ? 'text-primary' : 'text-[#2F3D4A]'}`}
                                                />
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                <div className="space-y-1">
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full h-20 bg-slate-100 border-2 border-border focus:border-primary rounded-xl px-4 py-3 text-xs font-medium outline-none resize-none transition-all shadow-inner custom-scrollbar text-[#2F3D4A] placeholder:text-muted-foreground/50"
                                                    />
                                                </div>
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full bg-slate-100 border-2 border-border focus:border-primary rounded-xl px-4 py-2.5 text-xs font-medium outline-none transition-all shadow-inner text-[#2F3D4A] placeholder:text-muted-foreground/50"
                                                    />
                                                </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div className="space-y-1">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-slate-100 border-2 border-border focus:border-primary rounded-xl px-3 py-2 text-[11px] font-medium outline-none transition-all text-[#2F3D4A] placeholder:text-muted-foreground/50"
                                                        />
                                                    </div>
                                                    <div className="space-y-1">
