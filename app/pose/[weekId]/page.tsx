            ...
            <div className="relative mx-auto max-w-5xl px-6 pt-10">
                <section className="pb-12">
                    <div className="max-w-3xl">
                        <p className="text-[11px] font-black uppercase tracking-[0.4em] text-blue-400/70">POSE Week {poseWeekNum}</p>
                        <div className="mt-5 flex items-start gap-4">
                            <div className="mt-1 h-16 w-1 rounded-full bg-gradient-to-b from-blue-400 via-blue-400/40 to-transparent" />
                            <div>
