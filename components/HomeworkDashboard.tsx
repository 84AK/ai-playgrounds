                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        {step.id > 0 && (
                            <button 
                                ...
                                disabled={!!isDeleting}
                                className="text-[10px] font-black text-rose-900 bg-rose-100 border border-rose-900 px-2 py-0.5 rounded-md uppercase hover:bg-rose-200 disabled:opacity-50 transition-colors"
                            >
                                {isCurrentDeleting ? "대기..." : "삭제"}
                            </button>
                        )}
                    </div>
                ) : (
